<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DeveloperList.aspx.cs" Inherits="TECHNETWORK.DeveloperList" %>
	...
	<div class="container">  
			<div class="w3-welcome heading">
                 <% if(Session["Authorizer"]=="Admin")
                            { %>
                 <a href="AddDeveloper.aspx" style="color:black;float:right"> <h4> <i class="fa fa-arrow-right"></i>  Add developer</h4></a>
                  <% }%>
		...
		<div id="verticalTab">
			<ul class="resp-tabs-list">
                <% 
                    var ListDeveloperList = ListOfDevelopers();
                    Random rd = new Random();
                    var picid = 0;
                    Dictionary<int, int> keyValuePairs = new Dictionary<int, int>();
                    foreach (var developer in ListDeveloperList)
                    {
                        picid =int.Parse(rd.Next(1, 4).ToString());
                        keyValuePairs.Add(developer.Id,picid);
                        %>
                <li>
			...
			<div class="resp-tabs-container">
              <% 
                  ...
                  foreach (var developer in ListDeveloperList)
                  {
                          picid = keyValuePairs[developer.Id];
                     
                      %>
			<div>
				<div class="col-md-7 tabs-right1">
						<h3><%= developer.Developer_name %></h3>
						<h4>||<%= developer.Designation %>|| CODE:<%= developer.Developer_code %></h4>
						<ul class="social">
						...
						<div class="tab-bottom">
							<p><i class="fa fa-map-marker" aria-hidden="true"></i><%= developer.Address %></p>
							<p><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:mail@example.com"><%= developer.Email_id %></a></p>
							<p><i class="fa fa-phone" aria-hidden="true"></i><%= developer.Phone_number %></p>
						</div>
