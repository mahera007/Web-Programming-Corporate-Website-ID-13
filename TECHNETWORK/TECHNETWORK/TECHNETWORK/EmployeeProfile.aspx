<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EmployeeProfile.aspx.cs" Inherits="TECHNETWORK.EmployeeProfile" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <br /><br />
    <section class="contact py-5" id="contact">
	<div class="container py-sm-3">
		<h1 class="heading text-capitalize mb-lg-5 mb-4" style="margin-bottom:1rem !important">Update profile</h1>
        <form  method="post">
            ...
            <div class="row main-agile-sectns">
                ...
                <div class="col-md-6 agileits-btm-spc form-text1">
                    <asp:TextBox ID="EmpAddress" runat="server" TextMode="MultiLine"  placeholder="Employee address" ></asp:TextBox>
             ...
             <asp:Button ID="Sbmt_btn"  class="btn" runat="server" Text="Update" OnClick="Sbmt_btn_Click"  />
